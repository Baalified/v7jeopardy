...
function QuestionAnswerVideo({ question, socket }) {
  ...
  return (
    <div className="question-video">
      <video ref={videoRef} muted={isGameMaster} preload="auto" autoPlay>
        <source src={question.answerMediaUrl} type="video/mp4" />
...
export default QuestionAnswerVideo;
